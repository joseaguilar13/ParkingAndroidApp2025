...
public final class MenuBinding implements ViewBinding {
  ...
  private MenuBinding(@NonNull ConstraintLayout rootView, @NonNull Button button1,
      @NonNull Button button3, @NonNull ImageButton imageButton) {
  ...
  public static MenuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MenuBinding((ConstraintLayout) rootView, button1, button3, imageButton);
    }
